...
class Config(object):
    ...
    SESSION_NAME = os.environ.get("SESSION_NAME", "Brutal_File_Rename_Bot")
    ...
    MONGODB_URI = os.environ.get("MONGODB_URI", "mongodb+srv://mhsm:mhsm@cluster0.j9figvh.mongodb.net/?retryWrites=true&w=majority")
